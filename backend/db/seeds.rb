...
package1 = Package.create(address: "555 Street Ln", item: "candle", delivery_status: true)
package2 = Package.create(address: "123 Road Dr", item: "shirt", delivery_status: true)
package3 = Package.create(address: "999 First St", item: "screwdriver", delivery_status: true)
package4 = Package.create(address: "000 Path Way", item: "oatmeal", delivery_status: true)
